...
// Updated Avatar interface to include an image URL (if needed)
interface Avatar {
  name: string;
  simli_faceid: string;
...
const avatar: Avatar = {
  ...
  initialPrompt:
    'Say this introduction: Welcome to your local Create-Simli-App, the interactive demo for Simli that you can start building from. You can swap me out with other characters.',
};
  ...
  return (
    <div className="bg-black min-h-screen flex flex-col items-center font-abc-repro font-normal text-sm text-white p-8">
      ...
      <div className="absolute top-[32px] right-[32px]">
        <span className="font-bold mb-8 text-xl leading-8">Create Simli App</span>
      </div>
      ...
      <div className="max-w-[350px] font-thin flex flex-col items-center ">
        ...
        <ul className="list-decimal list-inside max-w-[350px] ml-[6px] mt-2">
          ...
          <li className="mb-1">
            You can replace the avatar's face and voice and initial prompt with your own. Do this by editing{' '}
